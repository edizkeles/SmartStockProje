...
export default function CustomerView() {
  ...
  const filteredProducts = products.filter((u) => {
    ...
    const catId = u.kategori_id?.toString() || u.kategori?.id?.toString();
          ...
          <button
            ...
            className={`px-4 py-2 text-xs font-semibold rounded-lg border transition-all cursor-pointer ${
              activeCategory === 'all'
                ...
                : 'bg-white dark:bg-slate-900 text-slate-600 dark:text-slate-300 border-slate-200 dark:border-slate-800 hover:border-slate-350 hover:bg-slate-50 dark:hover:bg-slate-800'
            }`}
          >
            Tümü
          </button>
