...
import { saveProductMutationLog } from '../store/slices/purchaseLogSlice';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (productToEdit) {
        ...
        dispatch(saveProductMutationLog({
          username: currentUser?.username || 'admin',
          productName: ad,
          actionType: 'Ekleme',
          details: `Barkod: ${barkod}, Fiyat: ${fiyat} TL, Miktar: ${stok_miktari} ${urun_tipi === 'Gida' ? 'kg' : 'Adet'}`
        }));
